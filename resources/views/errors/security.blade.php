...
<head>
 ...
 @include('core-tools-views::errors.style')
</head>
<body>
 <main class="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
  <h1 class="text-9xl font-extrabold text-white tracking-widest">{{ isset($code) ? $code : '403' }}</h1>
  ...
  <button class="mt-5">
   <div class="text-white my-3"> {{ isset($message) ? $message : 'Suspicious request detected. Your action has been logged.' }}</div>
